...
filename = politician.__class.__name__.lower()

management = Management(student_id="28647", student_name= "Kristel Frisnedi", course= "BSIT", section= "A", year_level= "2nd")
filename = management.__class.__name__.lower()

bank = Bank(bank_name="74859", account_id= "Coffee", account_name= "Salted Caramel", account_status= 120, balance= "Medium", last_transaction= "02-19-2026")
filename = bank.__class.__name__.lower()
